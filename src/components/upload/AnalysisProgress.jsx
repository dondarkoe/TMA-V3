...
export default function AnalysisProgress({ stage, filename }) {
  const stages = [
    {
      id: 'uploading',
      icon: Upload,
    ...
    },
    {
      ...
      description: 'AI is examining your mix and master...'
    },
    {
      id: 'completed',
      icon: CheckCircle,
      title: 'Analysis Complete',
      description: 'Generating your detailed report...'
    }
  ];
      ...
      <CardContent className="p-8">
        ...
        <div className="mt-8 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-500/10 border border-blue-500/30 rounded-full">
            ...
            <span className="text-blue-300 text-sm">This usually takes 30-60 seconds</span>
          </div>
        </div>
      </CardContent>
    </Card>
